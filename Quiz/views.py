...
from .forms import RegisterFormulario, UsuariologinFormulario
from .models import Pregunta, QuizUsuario, PreguntasRespondidas
...
def jugar(request):
    ...
    if request.method =='POST':
        ...
        return redirect('result',pregunta_respondida.pk)
